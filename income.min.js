...
var isMoblie = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),
  income = isMoblie
    ? {
        1: { type: 1, content: '' },
        2: { type: 2, content: 'https://img.nktcw.cn/1364.js' },
        3: { type: 1, content: '' },
        4: { type: 2, content: 'https://img.nktcw.cn/1364.js' },
        5: { type: 2, content: 'https://m.xi7h.cn/37/44707.js' },
        6: { type: 1, content: '' },
        7: { type: 1, content: '' },
        8: { type: 3, content: 'https://www.99496.com/in/in.html' },
        9: { type: 2, content: 'https://m.xi7h.cn/19/46341.js?Math.round(Math.random() * 10000)' },
        10: {},
        11: { type: 2, content: 'https://img.nktcw.cn/1364.js' }
      }
    : {
        1: { type: 1, content: '' },
        2: {
        ...
        5: { type: 2, content: 'https://19.dlads.cn/musics.php?id=889' },
        6: {
          type: 1,
          content:
