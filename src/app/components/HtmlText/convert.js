...
function youtube(html) {
  ...
  arr.map(str => {
    ...
    if (id) {
      ...
      html = html.replace(
        str,
        `<iframe width="100%" style="background:#f9f9f9;" src="${url}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`
      )
    }
  })
