window.webPictureViewer = (function() {
  ...
  box.prototype.scale = function(width, animation) {
    ...
    setCSS(this.images[this.currentImgIndex], {
      transform:
        'scale(' + imgInfo.scale + ',' + imgInfo.scale + ') translate(' + imgInfo.translate.x + 'px, ' + imgInfo.translate.y + 'px)'
    })
  }
  ...
  box.prototype.adjustPosition = function(index, width) {
    ...
    setCSS(this.images[index], {
      transform: 'scale(' + scale + ', ' + scale + ') translate(' + targetPosition.x + 'px, ' + targetPosition.y + 'px)'
    })
    ...
    addCSS(
      '@keyframes fadeIn { 0% { transform:scale(' +
        img.scale +
        ', ' +
        img.scale +
        ') translate(' +
        ...
        targetPosition.y +
        'px); }} ' +
        '@-ms-keyframes fadeIn { 0% { -ms-transform:scale(' +
        img.scale +
        ', ' +
        img.scale +
        ') translate(' +
        ...
        targetPosition.y +
        'px); }} ' +
        '@-moz-keyframes fadeIn { 0% { -moz-transform:scale(' +
        img.scale +
        ', ' +
        img.scale +
        ') translate(' +
        ...
        targetPosition.y +
        'px); }} ' +
        '@-webkit-keyframes fadeIn { 0% { -webkit-transform:scale(' +
        img.scale +
        ', ' +
        img.scale +
        ') translate(' +
        ...
        targetPosition.y +
        'px); }} ' +
        '@-o-keyframes fadeIn { 0% { -o-transform:scale(' +
        img.scale +
        ', ' +
        img.scale +
        ') translate(' +
  ...
  box.prototype.mobileInit = function() {
    ...
    this.$marklayer.ontouchend = function(event) {
      if (!move) {
        ...
        let img = self.imagesInfo[self.currentImgIndex]
        ...
        if (vertical === false) {
          ...
          if (self.images[toIndex]) {
            ...
            var str =
              ' fadeIna { 0% { transform:' +
              self.images[self.currentImgIndex].parentNode.style.transform +
              '; } 100% { transform:translate(' +
              -(self.clientWidth * self.currentImgIndex) +
              'px, 0px); }} '
          ...
          if (self.images[index]) {
            if (self.images[toIndex]) {
              offset = targetX > 0 ? -30 : 30
            }

            let str =
              ' fadeInb { 0% { transform:' +
              self.images[index].parentNode.style.transform +
              '; } 100% { transform:translate(' +
              -(self.clientWidth * self.currentImgIndex + offset) +
              'px, 0px); }} '
  ...
  box.prototype.mobile = function(images, index) {
    ...
    for (var i = 0, max = images.length; i < max; i++) {
      ...
      setCSS(div, {
        ...
        width: '100%',
        height: '100%',
        left: 100 * (this.images.length - 1) + '%',
        top: 0,
        transform: 'translate(-' + this.currentImgIndex * this.clientWidth + 'px, 0px)'
      })
