...
export default {
  api: {
    ...
    recommendNews: () => `${API}api.php?s=home-react-newsList-id-211,206,205,207,208,209,212,213,221,222-day-7-limit-4-order-hits_week-p-0`, // 首页最近7天热门新闻
    ...
    newsTextList: () => `${API}api.php?s=home-react-newsList-id-214,215,216,217,218,219,220,223-limit-15-order-addtime-p-0`, // 首页新闻文字
