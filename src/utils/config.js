export default {
  api: {
    login: 'http://www.ikanfan.com/api.php?s=home-search-login',
    ...
    newsDetail: 'http://www.ikanfan.com/api.php?s=home-news-readdetail-id-',  // 新闻内容接口
    week: ({ limit }) => `http://www.ikanfan.com/api.php?s=home-search-reactWeek&limit=${limit}`,  // 每周追番
    /**
	 * 排行榜
	 * $hits
	 * hits 总排行
